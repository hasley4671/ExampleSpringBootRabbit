...
public class RabbitMQExchangeConfiguration {
	...
	Exchange newExchange() {
		return ExchangeBuilder.directExchange("TopicTestExchange").autoDelete().internal().build();
	}
	...
	Exchange headersExchange() {
		return ExchangeBuilder.headersExchange("HeadersTestExchange").durable(true).internal().ignoreDeclarationExceptions().build();
	}
